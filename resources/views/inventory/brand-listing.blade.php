    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between bg-white border border-gray-200 dark:bg-neutral-800 dark:border-neutral-700 rounded-xl p-6 mb-6 shadow-sm">
        <div>
            <h1 class="text-lg font-bold text-gray-800 dark:text-white flex items-center gap-2">
                ...
                <span>Master Brand (Brands)</span>
            </h1>
            <p class="text-xs text-gray-500 dark:text-neutral-400 mt-1">Mengelola merk/brand produk handphone yang terdaftar</p>
        </div>
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-800 dark:border-neutral-700">
        ...
        <div class="p-5 border-b border-gray-200 dark:border-neutral-700 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="relative w-full md:w-72">
                <input type="text" placeholder="Cari brand..." class="py-2 ps-10 pe-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
        ...
        <x-table>
            <thead class="bg-gray-50 dark:bg-neutral-700/40">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-start text-xs font-semibold text-gray-500 uppercase dark:text-neutral-400">Nama Brand</th>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-800 dark:text-white">B01</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-white font-medium">Realme</td>
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-800 dark:text-white">B02</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-white font-medium">Xiaomi</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                        <x-badge variant="success">Aktif</x-badge>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium flex items-center justify-end gap-2">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-800 dark:text-white">B03</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-white font-medium">Infinix</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                        <x-badge variant="success">Aktif</x-badge>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium flex items-center justify-end gap-2">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-800 dark:text-white">B04</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-white font-medium">Apple</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                        <x-badge variant="success">Aktif</x-badge>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium flex items-center justify-end gap-2">

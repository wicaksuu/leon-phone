    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between bg-white border border-gray-200 dark:bg-neutral-800 dark:border-neutral-700 rounded-xl p-6 mb-6 shadow-sm">
        <div>
            <h1 class="text-lg font-bold text-gray-800 dark:text-white flex items-center gap-2">
                ...
                <span>Kelompok Std. Harga Jual</span>
            </h1>
            <p class="text-xs text-gray-500 dark:text-neutral-400 mt-1">Mengelola standardisasi kelompok harga jual barang berdasarkan cabang</p>
        </div>
        <div class="mt-4 md:mt-0 flex gap-2">
            <x-button variant="primary" class="flex items-center gap-2">
                ...
                <span>Tambah Kelompok Harga</span>
            </x-button>
        </div>
    </div>
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-800 dark:border-neutral-700">
        ...
        <div class="p-5 border-b border-gray-200 dark:border-neutral-700 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="relative w-full md:w-72">
                <input type="text" placeholder="Cari kelompok harga..." class="py-2 ps-10 pe-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
        ...
        <x-table>
            <thead class="bg-gray-50 dark:bg-neutral-700/40">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-start text-xs font-semibold text-gray-500 uppercase dark:text-neutral-400">Nama Kelompok Harga</th>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-800 dark:text-white">STD-RETAIL</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-neutral-300 font-mono">F-PRICE-01</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-white font-medium">Harga Standard Toko Retail</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-neutral-300">Leon Roxy Mas (Pusat)</td>
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-800 dark:text-white">STD-GROSIR</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-neutral-300 font-mono">F-PRICE-02</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-white font-medium">Harga Grosir Reseller</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-neutral-300">Leon Roxy Mas (Pusat)</td>
                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium flex items-center justify-end gap-2">
                        <button class="text-blue-600 hover:text-blue-900 dark:text-blue-500"><iconify-icon icon="solar:pen-linear" class="text-lg"></iconify-icon></button>
                        <button class="text-red-600 hover:text-red-900 dark:text-red-500"><iconify-icon icon="solar:trash-bin-trash-linear" class="text-lg"></iconify-icon></button>

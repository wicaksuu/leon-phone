    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between bg-white border border-gray-200 dark:bg-neutral-800 dark:border-neutral-700 rounded-xl p-6 mb-6 shadow-sm">
        <div>
            <h1 class="text-lg font-bold text-gray-800 dark:text-white flex items-center gap-2">
                ...
                <span>Perakitan § Pemakaian Bahan Baku</span>
            </h1>
            <p class="text-xs text-gray-500 dark:text-neutral-400 mt-1">Mengelola pemakaian komponen/bahan baku (bundling) sebelum dirakit menjadi barang jadi</p>
        </div>
        <div class="mt-4 md:mt-0 flex gap-2">
            <x-button variant="primary" class="flex items-center gap-2">
                ...
                <span>Buat Pemakaian Bahan</span>
            </x-button>
        </div>
    </div>
        ...
        <x-table>
            <thead class="bg-gray-50 dark:bg-neutral-700/40">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-center text-xs font-semibold text-gray-500 uppercase dark:text-neutral-400">Total Qty Bahan</th>
                    <th scope="col" class="px-6 py-3 text-end text-xs font-semibold text-gray-500 uppercase dark:text-neutral-400">Nilai Total Bahan</th>
                    <th scope="col" class="px-6 py-3 text-start text-xs font-semibold text-gray-500 uppercase dark:text-neutral-400">Keterangan</th>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-800 dark:text-white">RM-2026/08-0002</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-neutral-300 font-mono">05-08-2026</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-center font-bold text-gray-600 dark:text-neutral-300">10 PCS</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-end text-gray-800 dark:text-neutral-200 font-mono font-bold">Rp 15.500.000</td>
                    <td class="px-6 py-4 text-sm text-gray-600 dark:text-neutral-300">Bahan Baku Perakitan Bundling Giftbox Realme</td>

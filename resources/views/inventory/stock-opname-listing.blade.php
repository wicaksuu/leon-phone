    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between bg-white border border-gray-200 dark:bg-neutral-800 dark:border-neutral-700 rounded-xl p-6 mb-6 shadow-sm">
        <div>
            <h1 class="text-lg font-bold text-gray-800 dark:text-white flex items-center gap-2">
                ...
                <span>Transaksi Stok Opname</span>
            </h1>
            <p class="text-xs text-gray-500 dark:text-neutral-400 mt-1">Audit berkala kesesuaian jumlah stok fisik HP vs pencatatan database sistem</p>
        </div>
        ...
        <x-table>
            <thead class="bg-gray-50 dark:bg-neutral-700/40">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-start text-xs font-semibold text-gray-500 uppercase dark:text-neutral-400">Cabang / Gudang</th>
                    <th scope="col" class="px-6 py-3 text-center text-xs font-semibold text-gray-500 uppercase dark:text-neutral-400">Jumlah Item</th>
                    <th scope="col" class="px-6 py-3 text-end text-xs font-semibold text-gray-500 uppercase dark:text-neutral-400">Selisih (Stok vs Fisik)</th>
                    <th scope="col" class="px-6 py-3 text-start text-xs font-semibold text-gray-500 uppercase dark:text-neutral-400">Pemeriksa</th>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-800 dark:text-white">SO-2026/08-0001</td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-white">
                        <div>Leon Roxy Mas</div>
                        <div class="text-xs text-gray-400 dark:text-neutral-500">PT LEON</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-center font-bold text-gray-600 dark:text-neutral-300">1,843</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-end text-rose-600 font-bold">-2 PCS</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-neutral-300">L01 - Administrator</td>
